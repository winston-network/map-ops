...
const App = (function() {
    ...
    async function autoLoadLayers() {
        ...
        const layerStyles = {
            ...
            'relevant_polygons': {
                ...
                lineOpacity: 0.8,
                lineWidth: 2,
                // Hide features with all avy metadata fields null (matches mobile).
                // Toggle off by setting to null; source data is untouched.
                polygonFilter: ['any',
                    ['!=', ['get', 'starting_1'], null],
                    ['!=', ['get', 'starting_z'], null],
                    ['!=', ['get', 'vertical_f'], null],
    ...
    function setupEventListeners() {
        ...
        const reportContacts = document.getElementById('report-contacts');
        if (reportToggle && reportContacts) {
            reportToggle.addEventListener('click', () => {
                ...
                reportContacts.hidden = expanded;
                reportToggle.textContent = expanded ? 'Show contacts' : 'Hide contacts';
            });
        }
